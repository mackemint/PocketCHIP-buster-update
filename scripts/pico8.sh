my_process="env LD_PRELOAD=/usr/lib/pico-8/libcurl.so.3 /usr/lib/pico-8/pico8" # check with htop that this is where the process runs from, might be usr/lib/pico8
